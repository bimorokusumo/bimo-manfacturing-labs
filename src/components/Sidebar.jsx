...
const Sidebar = ({ activeMenu, setActiveMenu, onLogout, isOpen, closeSidebar }) => {
  ...
  const menus = [
    ...
    { id: 'gradebook', label: 'Monitoring Nilai Guru', badge: 'Guru', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  ];
  ...
  return (
    <div className="sidebar-container" style={{
      ...
      <div className="sidebar-footer" style={{ padding: '16px', borderTop: '1px solid var(--border-light)', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {isLoggedIn && (
          <div style={{ background: '#f8fafc', padding: '10px 12px', borderRadius: '10px', border: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ overflow: 'hidden', flex: 1, marginRight: '6px' }}>
              ...
              <div style={{ fontSize: '0.7rem', color: '#64748b' }}>
                Absen {student.studentNumber} • {student.className}
              </div>
            </div>
            <button
